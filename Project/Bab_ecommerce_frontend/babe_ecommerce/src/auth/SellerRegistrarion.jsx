    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                setTimeout(() => {
                    navigate("/seller-signup/become_seller", { state: { userId: response?.data?.id } });
                }, 1500);
            } catch (error) {
    ...
    return (
        <>
            ...
            <div
                ...
                // }}
            >
                <div className="w-full max-w-2xl px-8 py-6 bg-white bg-opacity-95 rounded-2xl shadow-2xl">
                    <h2 className="text-3xl font-bold text-gray-800 text-center mb-2">
                        Create Your Seller Account
                    </h2>
                    <p className="text-center text-sm text-gray-600 mb-6">
                        Join us today — grow your business and reach more customers!
                    </p>
