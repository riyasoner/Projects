...
const AddCashbackRules = () => {
    ...
    const handleSubmit = async (values, { resetForm }) => {
        try {
            ...
            const response = await post(endpoints.createCashbackRule, payload);
            toast.success(response.message || "Cashback rule created");
            resetForm();
            navigate(-1);
        } catch (error) {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-10">
            ...
            <h2 className="text-2xl font-bold mb-6">Add Cashback Rule</h2>
...
export default AddCashbackRules;
