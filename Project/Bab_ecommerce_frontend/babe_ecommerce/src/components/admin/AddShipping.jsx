...
const AddShipping = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      ...
      const res = await post(endpoints.createShippingFee, payload);
      toast.success(res.message || "Shipping fee created successfully");
      resetForm();
      setSelectedType("");
      navigate(-1);
    } catch (err) {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-10">
      ...
      <h2 className="text-2xl font-bold mb-6">Create Shipping Rule</h2>
