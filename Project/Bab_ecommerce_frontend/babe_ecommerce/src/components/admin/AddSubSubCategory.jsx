...
function AddSubSubCategory() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("categoryId", selectedParentId),
    ...
    try {
      const response = await post(endpoints.createSubCategory, form);
  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6 mt-10">
      <h2 className="text-2xl font-bold mb-6 text-center">Add Subcategory</h2>
