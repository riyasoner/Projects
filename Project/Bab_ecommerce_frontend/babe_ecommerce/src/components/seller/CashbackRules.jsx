...
const CashbackRules = () => {
    ...
    const fetchCashbackRules = async (page) => {
        try {
            const response = await get(`${endpoints.getCashbackRules}?sellerId=${userId}&page=${page}`);
        ...
        <div className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    onClick={() => navigate("/seller/add-cashback-rules")}
                >
                    Add Cashback Rule
                </button>
            </div>
                                    ...
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                onClick={() =>
                                                    navigate("/seller/view_cashbackRule", { state: { id: item.id } })
                                                }
                                            >
                                                <FaEye size={16} />
                                            </button>
